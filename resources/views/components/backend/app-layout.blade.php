                        ...
                        <div class="dropdown-menu dropdown-menu-right notification">
                            <div class="noti-head">
                                ...
                                <div class="float-right">
                                    <a href="{{ route('counselor.notification.list') }}" class="m-r-10">mark as read</a>
                                </div>
                            </div>
                            <ul class="noti-body">
                                    ...
                                    <li class="notification">
                                        <div class="media">
                                            <img class="img-radius"
                                                src="{{ foto_profil($notification->data['foto']) }}"
                                            ...
                                            <div class="media-body">
                                                ...
                                                <p>{{ $notification->data['messages'] }}</p>
                                            </div>
                                        </div>
                                    </li>
                                @endforeach
                            ...
                            <div class="noti-footer">
                                @if (auth()->user()->role == 'counselor')
                                    <a href="{{ route('counselor.notification') }}">show all</a>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="dropdown drp-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-notification">
                            <div class="pro-head">
                                ...
                                @if ($role == 'counselor')
                                    <a href="{{ route('counselor.logout') }}" onclick="confirm('Yakin ingin logout?')"
                                        class="dud-logout" title="Logout">
                                        <i class="feather icon-log-out"></i>
                                    </a>
                                @endif
