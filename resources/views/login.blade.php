...
<head>
    <!-- Basic Page Info -->
    <meta charset="utf-8">
    <title>{{ $title ?? '' }} E-Konseling Universitas Khairun</title>
    ...
    <div class="login-header box-shadow">
        <div class="container-fluid d-flex justify-content-between align-items-center">
            <div class="brand-logo">
                <a href="login.html">
                    <img src="{{ asset('images') }}/logo.jpg" alt="" style="width: 40px;" class="mb-2 mr-2">
                    <h4>E-KONSELING UNKHAIR</h1>
                </a>
            </div>
                            ...
                            <div class="select-role">
                                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                    <label class="btn active">
                                        ...
                                        <div class="icon"><img
                                                src="{{ asset('backend') }}/vendors/images/briefcase.svg" class="svg"
                                                alt=""></div>
                                        <span>I'm</span>
                                        Manager
                                    </label>
                                    <label class="btn">
                                        ...
                                        <div class="icon"><img src="{{ asset('backend') }}/vendors/images/person.svg"
                                                class="svg" alt=""></div>
                                        <span>I'm</span>
                                        Employee
                                    </label>
